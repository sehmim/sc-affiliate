...
const fs = require('fs');
const { fetchHostPermissions } = require('./src/utils/buildHelper');
const { urlGetSyncedCampaigns } = require('./src/utils/env');

// Function to generate manifest.json dynamically
function createManifest() {

  try {
    const domains = fetchHostPermissions(urlGetSyncedCampaigns);
