...
// Component to display Awin tracking links
const AwinTrackingLinks = () => {
  ...
  useEffect(() => {
    const fetchTrackingLinks = async () => {
      try {
        setIsLoading(true);
        const querySnapshot = await getDocs(collection(firestore, 'awinDeeplink'));
...
export default AwinTrackingLinks;
