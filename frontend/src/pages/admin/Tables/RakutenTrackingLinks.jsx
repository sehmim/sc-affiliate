...
// Component to display Rakuten tracking links
const RakutenTrackingLinks = () => {
  ...
  useEffect(() => {
    const fetchTrackingLinks = async () => {
      try {
        setIsLoading(true);
        const querySnapshot = await getDocs(collection(firestore, 'rakutenDeeplink'));
...
export default RakutenTrackingLinks;
