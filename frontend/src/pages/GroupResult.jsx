...
/**
 * @NOTE This is the actual code and the reason why I commented this out
 * is because I want to bypass the `invitation group code does not exist` error.
 * I wanted to see if the function that I created in the backend works, and it does.
 * - Julio
 */
...
//        const response = await fetch(`${getPaymentsUrl}?charity=${id}`, {
//           headers: {
