...
const Register = () => {
  ...
  return (
    <div className="font-lato" style={{ width: "100%" }}>
      <Header />
      <div
        className="flex flex-col items-center gap-2 border bg-white py-5 rounded-lg"
      ...
      >
        ...
        <div className="mt-5 flex flex-col w-9/12 gap-2">
          <label htmlFor="fname" className="text-deep-purple">
            First Name
          </label>
          <input
            ...
            id="fname"
          ></input>
          <label htmlFor="lname" className="text-deep-purple">
            Last Name
          </label>
          <input
            className="text-xl p-2 border-b-2 border-grey outline-none focus:border-deep-purple"
        ...
        <p className="text-grey">
          ...
          <a className="pl-2 text-deep-purple" href="/login">
            Sign In
          </a>
        </p>
        <button
          className="my-2 w-9/12 bg-deep-purple text-white text-xl py-2 rounded-md font-montserrat"
          onClick={subHandle}
        >
          Register
        </button>
